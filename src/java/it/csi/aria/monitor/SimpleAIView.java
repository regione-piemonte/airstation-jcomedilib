...
// ----------------------------------------------------------------------------
// $Id: SimpleAIView.java,v 1.3 2003-12-22 16:02:45 pfvallosio Exp $
// ----------------------------------------------------------------------------
...
public class SimpleAIView extends JPanel
    implements AnalogicInputView
{
    ...
    public SimpleAIView(String name, double minValue, double maxValue,
